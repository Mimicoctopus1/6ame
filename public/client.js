...
if (localStorage.signedIntoGame != 'true') {
	...
	messages.innerHTML +=
		"<li>Please type the word 'buzz' right after the arrow, then press enter. <a class = 'buzzActivation' href = '#');\">Not working? Click here!</a></li>";
} else {
...
var startRecording = async function(e) { 
    ...
    socket.emit('mediaUpload', mediaPreview.src);        /*Tell the server to upload this to my file storing system.*/
